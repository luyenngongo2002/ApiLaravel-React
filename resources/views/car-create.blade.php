...
<div class="container">
    ...
    <form action="{{route('cars.store')}}" class="was-validated" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="" placeholder="Enter description" name="des" required>
            <div class="valid-feedback"></div>
            <div class="invalid-feedback"></div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control" id="" placeholder="Enter date" name="pro_on" required>
            <div class="valid-feedback"></div>
            <div class="invalid-feedback"></div>
        </div>
